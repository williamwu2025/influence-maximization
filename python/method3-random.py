...
u=[-1.0]*number_of_neighbor;
while u[number_of_neighbor-1]<0 or u[number_of_neighbor-1]>1:
    sum=0;
    for i in range(0,number_of_neighbor-1):
        u[i]=random.random();
        sum+=u[i];
    u[number_of_neighbor-1]=50-sum;
